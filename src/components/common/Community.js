...
export function Community() {
  ...
  const content = [
    ...
    <a href={infernoOpenCollective} target="_blank"><img src={ infernoOpenCollective + "/backers.svg?width=890"}/></a>,
    <h4>Sponsors</h4>,
  ...
  for (let i = 0; i < SPONSORS_COUNT; i++) {
    content.push(<a href={`${infernoOpenCollective}/sponsor/${i}/website`} target="_blank"><img alt="" src={`${infernoOpenCollective}/sponsor/${i}/avatar.svg`}/></a>);
  }
